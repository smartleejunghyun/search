...
<%userDTO info = (userDTO) session.getAttribute("info"); %>
    ...
    <div class="container text">
        <div class="row row-cols-12">
          <div class="col"><h2>나만의 옷 스타일을 추천해드립니다</h2></div>
        </div> 
        <div class="row row-cols-12">
          <div class="col col-lg-12"><p>Our searchsearch is a web service that recommends your clothing styles.</p></div>
        </div> 
        <div class="row row-cols-12">
          <div class="col col-lg-12"><p>We also recommend shopping mall sites that match your clothing style.</p></div>
        </div>
      </div>
    ...
    <div class="d-grid gap-2 col-3 mx-auto">
        <button class="btn btn-default main_cloth" onclick="toMain()" type="button">옷 사진 올리기</button>
    </div>
    ...
    <div class="container carousel">
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-wrap="true" data-bs-pause="false" data-bs-keyboard="false" data-bs-interval="2000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://github.com/yoonseo1004/yoonseo/blob/main/images/main_slide04.jpg?raw=true" class="d-block w-100">
            ...
            <div class="carousel-item" data-bs-interval="2000">
                <img src="https://github.com/yoonseo1004/yoonseo/blob/main/images/main_slide05.jpg?raw=true" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" data-bs-interval="2000">
                <img src="https://github.com/yoonseo1004/yoonseo/blob/main/images/main_slide03.jpg?raw=true" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
